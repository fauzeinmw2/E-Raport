...
<div class="pd-20 card-box mb-30">
    ...
    <form action="proses.php?act=simpanSiswa" method="post">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-12 col-md-10">
                <input class="form-control" name="nama_siswa" type="text" require>
            </div>
        </div>
